...
// Generated 12-May-2021 13:37:15
...
#include "flow_model_Nathan_05_01_2021.h"
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"flow_model_Nathan_05_01_2021\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(flow_model_Nathan_05_01_2021_M, (NULL));
        flow_model_Nathan_05_01_2021_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(flow_model_Nathan_05_01_2021_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(flow_model_Nathan_05_01_2021_M)
                == (NULL)) || rtmGetStopRequested(flow_model_Nathan_05_01_2021_M));
    ...
    void NodeInterface::terminate(void)
    {
      if (mBaseRateThread.get()) {
        ...
        flow_model_Nathan_05_01_2021_terminate();
        mNode.reset();
      }
    }
    ...
    {
      mRunModel = (rtmGetErrorStatus(flow_model_Nathan_05_01_2021_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
        ...
        if (!mRunModel)
          break;
        flow_model_Nathan_05_01_2021_step();
